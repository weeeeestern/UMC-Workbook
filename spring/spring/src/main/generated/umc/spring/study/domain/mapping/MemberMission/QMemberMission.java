...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 852135823L;
    ...
    public final umc.spring.study.domain.Member.QMember member;

    public final umc.spring.study.domain.QMission mission;

    public final EnumPath<MemberMissionStatus> status = createEnum("status", MemberMissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.spring.study.domain.Member.QMember(forProperty("member")) : null;
